...
Opening the application revealed a game interface with a message: "Reach the gate. Higher privilege required." The challenge comes with scenario files which contains an app/index.ts file displaying the workings of the api.
...
document.cookie = "session=inside.SIGNED\_VALUE; path=/"
